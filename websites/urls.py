...
from .views import (
    ...
    EmbeddingJobStatusView, WebsiteListCreateView, WebsitePagesAPIView, WebsiteSyncView
)
...
urlpatterns = [
    ...
    path("websites/<uuid:pk>/pages/", WebsitePagesAPIView.as_view(), name="website-pages",)
]